...
```{r}
library(readxl)
bw <- read_excel("~/home/Git/irreg/data/BW-Zooplankton_env.xls")
summary(bw[,1:10])
...
Bilinear triangulation. This is identical to Matlab's griddata(, method = "bilinear")
